...
@Component({
  selector: 'app-asignar-desde-cursos',
  templateUrl: './asignar-desde-cursos.component.html',
  styleUrls: ['./asignar-desde-cursos.component.scss']
})
export class AsignarDesdeCursosComponent implements OnInit {
  ...
  cancelar() {
    this.modoEdicion = false; // Cambiar de nuevo a vista normal
