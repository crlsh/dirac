...
@Component({
  selector: 'app-asignar-desde-ayp',
  templateUrl: './asignar-desde-ayp.component.html',
  styleUrls: ['./asignar-desde-ayp.component.scss']
})
export class AsignarDesdeAypComponent implements OnInit {
