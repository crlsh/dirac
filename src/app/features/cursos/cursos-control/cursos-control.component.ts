...
import { AsignarDesdeCursosComponent } from '../../asignaciones/asignar-desde-cursos/asignar-desde-cursos.component';
...
export class CursosControlComponent implements OnInit {
  ...
  openForm(modo: string, item: any) {
    if (modo === 'Alumnos') {
      const modalRef = this.modalService.open(AsignarDesdeCursosComponent, {
